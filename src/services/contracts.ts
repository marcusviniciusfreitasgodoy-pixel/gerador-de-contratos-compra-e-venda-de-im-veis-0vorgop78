...
export const saveContractDraft = async (
  ...
  const payload: Record<string, any> = {
    ...
    valor_financiamento: parseCurrencySafe(data.valor_financiamento || data.valor_financiado),
    valor_financiado: parseCurrencySafe(data.valor_financiamento || data.valor_financiado),
