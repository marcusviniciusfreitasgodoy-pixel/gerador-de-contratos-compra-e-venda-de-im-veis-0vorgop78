...
export function RichTextEditor({
  ...
  return (
    <div className="bg-white flex flex-col h-full rounded-b-md min-h-[500px] relative">
      <div className="flex items-center gap-1 p-2 border-b bg-slate-50 sticky top-0 z-10 shadow-sm">
        <Button
          variant="ghost"
          size="sm"
      ...
      <div className="relative flex-1">
        <div
          ...
          contentEditable
          onInput={handleInput}
          className="p-6 focus:outline-none prose max-w-none text-slate-800 leading-relaxed min-h-[450px]"
