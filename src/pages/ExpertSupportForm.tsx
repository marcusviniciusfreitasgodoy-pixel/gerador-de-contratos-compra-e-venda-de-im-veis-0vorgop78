...
import { Loader2, UserCheck, ArrowLeft, Paperclip, AlertCircle, Clock } from 'lucide-react'
            ...
            <Card className="shadow-sm border-slate-200">
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="space-y-2 border-t pt-4">
                  ...
                  {contractId && (
                    <div className="mt-2 text-sm text-blue-600 flex items-center gap-1 bg-blue-50 p-2 rounded">
                      <AlertCircle className="w-4 h-4" />O contrato analisado será automaticamente
                      vinculado a esta solicitação.
                    </div>
                  )}
                </div>
              </CardContent>
        ...
        <div>
          <Card className="sticky top-6 border-indigo-100 shadow-md">
            ...
            <CardContent className="pt-6 space-y-4">
              ...
              <div className="bg-indigo-50 p-3 rounded-lg text-xs text-indigo-800 mt-4 leading-relaxed">
